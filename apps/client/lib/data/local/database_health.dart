...
///
/// Drift opens lazily and remembers a failed open: once it throws, every
/// later query on that connection throws the same error. Every screen reads
/// from the database, so without a check up front one bad store takes the
/// whole app down at once, with nothing on screen to act on.
