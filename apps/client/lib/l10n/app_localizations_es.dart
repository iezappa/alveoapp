...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get staleStoreBody =>
      'Alveo está abierto en otra pestaña o ventana con una versión anterior, y mientras siga abierta esta no puede guardar nada. Tus datos están intactos. Cerrá todas las demás pestañas de Alveo y volvé a cargar esta página.';
}
