...
abstract class AppLocalizations {
  ...
  /// No description provided for @recoveryImportFailed.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Your version is too old to update directly. Export a backup and check the release instructions.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Alveo is open in another tab or window with an older version, and while it stays open this one cannot save anything. Your data is intact. Close every other Alveo tab, then reload this page.'**
