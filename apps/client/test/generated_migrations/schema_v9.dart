...
class TagsData extends DataClass implements Insertable<TagsData> {
  ...
  TagsData copyWith({String? id, String? name, int? updatedAt}) => TagsData(
    id: id ?? this.id,
    name: name ?? this.name,
    updatedAt: updatedAt ?? this.updatedAt,
  );
...
class ThoughtRecordDistortionsData extends DataClass
  ...
  ThoughtRecordDistortionsData copyWith({
    String? recordId,
    int? distortion,
    int? updatedAt,
